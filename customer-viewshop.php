	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				...
				<a href="customer-viewshop.php?companynm=<?php echo $shopname;?>&shopimage=<?php echo $shoppic;?>"><?php echo '<img src="shop_img/'.$shoppic.'" height="250" width="900" align="center" >';?> </a>
...
$sql5 = mysqli_query($link,"SELECT * FROM product WHERE companyname='$shopname' ");
...
?>
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="card">
          ...
          <div class="card-body" >
             <center><a href="customer-view-productdetails.php?id=<?php echo $p_id ;?>"><?php echo '<img src="pro_img/'.$p_image.'" height="300" width="200" class="img-thumnail" >';?></a></center><br>
             
            <h6><center><a href="customer-view-productdetails.php?id=<?php echo $p_id ;?>"><b><?php echo $p_name;  ?></a></center></b></h6>
