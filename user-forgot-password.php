...
$query=mysqli_query($link,"SELECT * FROM user WHERE user_email='$email' and user_contactno='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="user-forgot-password.php";
mysqli_query($link,"update user set user_password='$password' WHERE user_email='$email' and user_contactno='$contact' ");
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change3">Change</button>
	</form>					
</div>
<!-- Sign-in -->
