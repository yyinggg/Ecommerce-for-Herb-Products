...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<a href="seller-view-allproduct.php?companynm=<?php echo $name;?>&shopimage=<?php echo $shoppic;?>"><?php echo '<img src="shop_img/'.$shoppic.'" height="250" width="900" align="center" >';?> 
...
$start_from = ($page-1) * $limit;  
  ...
  if($user){
    $sql = mysqli_query($link,"SELECT * FROM product WHERE username='$name'");
    $productCount = mysqli_num_rows($sql);
        ...
        <input type="hidden" name="pid"  value="<?php echo $p_id; ?>" />
          ...
          <div class="btn-group d-flex">
            <form id="form1" name="form1" method="post" >
                ...
                <button type="button"><a href="seller-view-allproduct.php?delete=<?php echo $p_id ;?>">Delete</button>
          </div>
...
$result_db = mysqli_query($link,"SELECT COUNT(product_id) FROM product"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='seller-view-allproduct.php?companynm=<?php echo $name;?>&page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
