	            ...
	            <div class="accordion-heading">
	             <a href="goviewshop-mennutrition.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                 ...
	                 <a href="goviewshop-brain.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                  ...
	                  <a href="viewshop.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                 VIEW ALL PRODUCTS
	                </a>
	            </div>  
	        </div>
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				...
				<a href="viewshop.php?companynm=<?php echo $shopname;?>&shopimage=<?php echo $shoppic;?>"><?php echo '<img src="shop_img/'.$shoppic.'" height="250" width="900" align="center" >';?> </a>
...
?>
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="card">
          ...
          <div class="card-body" >
             <center><a href="cview-productdetails.php?id=<?php echo $p_id ;?>"><?php echo '<img src="pro_img/'.$p_image.'" height="300" width="200" class="img-thumnail" >';?></a></center><br>
             
            <h5><center><a href="view-productdetails.php?id=<?php echo $p_id ;?>"><b><?php echo $p_name;  ?></a></center></b></h5>
           <h5> <center>RM<?php echo  $p_price;  ?></h5> <center>
