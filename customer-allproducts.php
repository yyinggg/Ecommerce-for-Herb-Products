		...
		<div class="accordion">
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	               <a href="customer-mennutrition.php"  class="accordion-toggle collapsed">
	                   MEN'S NUTRITION
	                </a>
	                 <a href="customer-womennutrition.php"  class="accordion-toggle collapsed">
	                   WOMEN'S NUTRITION
	                </a>
...
$start_from = ($page-1) * $limit;   
  ...
  if($user){
    $sql = mysqli_query($link,"SELECT * FROM product ORDER BY product_id ASC LIMIT $start_from, $limit");
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="card">
          ...
          <div class="card-body" >
            ...
            <h5><center><a href="customer-view-productdetails.php?id=<?php echo $p_id ;?>"><b><?php echo $p_name;  ?></a></center></b></h5>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='customer-allproducts.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
