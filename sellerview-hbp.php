		...
		<div class="accordion">
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	              <a href="sellerview-hbp.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                   HIGH BLOOD PRESSURE 
	                </a>
	                 <a href="sellerview-flu.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                   FLU & COLD
	                </a>
	                 <a href="sellerview-heart.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                  HEART HEALTH
	                </a>
	                 <a href="vsellerview-immune.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                  IMMUNE HEALTH
	                </a>
	                 <a href="sellerview-kidney.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                   KIDNEY HEALTH
	                </a>
	                 <a href="sellerview-diabetes.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                   DIABETES 
	                </a>
	                 <a href="sellerview-brain.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                  BRAIN HEALTH 
	                </a>
	                  <a href="sellerview-liver.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                  LIVER HEALTH
	                </a>
	                  <a href="sellerview-eye.php?companynm=<?php echo $shopname;?>"  class="accordion-toggle collapsed">
	                   EYE HEALTH
	                </a>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<center><h3>HIGH BLOOD PRESSURE</h3></center>
							<div class="row">
       <?php
      $shopname=$_SESSION['companynm'];
if(isset($_REQUEST["companynm"])){
...
if($shopname){
$sql5 = mysqli_query($link,"SELECT * FROM product WHERE p_category='High Blood Pressure' AND companyname='$shopname'");
      ...
      <form method="post" enctype="multipart/form-data">
        <div class="card">
          ...
          <div class="card-body">
           ...
           <center><?php echo '<img src="pro_img/'.($row['p_image'] ).'" height="300" width="200" class="img-thumnail" >';?></center>
              <form id="form1" name="form1" method="GET" >
                 
        <input type="hidden" name="pid"  value="<?php echo $p_id; ?>" />
            <h6><center><a href="seller-view-productdetails.php?id=<?php echo $p_id ;?>"><?php echo $p_name ;?></a></center></b></h6>
           <h6> <center>RM<?php echo  $p_price;  ?><center></h6> 
