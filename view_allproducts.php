...
//$result = mysqli_query($link,"SELECT * FROM product ORDER BY product_id ASC LIMIT $start_from, $limit");
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='view_allproducts.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
