	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-3 sidebar">
				<!-- ================================== TOP NAVIGATION ================================== -->
	<?php include('includes/b4login-side-menu.php');?>
<!-- ================================== TOP NAVIGATION : END ================================== -->
			</div><!-- /.sidemenu-holder -->	
...
?>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="view-productdetails.php?id=<?php echo $p_id ;?>">
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="view-productdetails.php?id=<?php echo $p_id ;?>"><?php echo htmlentities($row['p_name']);?></a></h3>
